...
<link rel="stylesheet" href="{{ asset('/theme/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css')}}">
...
<link rel="stylesheet" href="{{ asset('theme/bower_components/select2/dist/css/select2.css') }}"/>
...
<!-- jQuery 3 -->
<script src="{{ asset('theme/bower_components/jquery/dist/jquery.min.js') }}" type="text/javascript"></script>
<!-- jQuery UI 1.11.4 -->
